export default {
  assessment_by_pk: {
    ...
    internal: false,
    key_information: {
      overview: 'new facts and figures',
      'management-structure': 'new structure and activities',
      'challenges-and-strategy': 'new challenges and strategy',
      'operations-partners-suppliers': 'new operations, partners and suppliers',
      'market-offerings-and-customers': 'new offerings and customers',
    },
    scoring: [],
